...
public class FrontEndService {
	 ...
	 */
	public static String entrarConjuntoCaracteres_Alfabeto() throws InterruptedException {
		String alfabeto;
		boolean b = false;
		do {
	...
	public static String entraConjuntoEstado() throws RemoteException, NotBoundException, InterruptedException {
		String estados;
		boolean b = false;
	...
	public static boolean valoresAtuais(String info, Character idUser)
	...
	public static String entraPalavra() throws InterruptedException, NotBoundException, IOException {
		String palavra;
		boolean b = false;
		...
		do {
			...
			if (palavra == null) {
				...
				AutomatoTesteLocalMain.automato.setMetetodoCorrente(0);
				;
